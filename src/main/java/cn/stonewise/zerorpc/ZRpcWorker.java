...
public class ZRpcWorker<THandler> implements Runnable {
    ...
    ZRpcWorker(LinkedBlockingQueue<ZMessage> requestqueue, LinkedBlockingQueue<ZMessage> replayqueue, Class<THandler> handlerClass) {
    ...
    public void run() {
        while (!Thread.currentThread().isInterrupted()) {
            try {
                final ZMessage req =  this.requestqueue.take();
//                if (req == null) {
//                    Thread.sleep(100);
//                    continue;
//                }
